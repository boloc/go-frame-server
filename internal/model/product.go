...
// Product.Status 的取值，供 repository 查询和 enum 展示文案引用。
const (
	ProductStatusListed   = 1 // 上架
	ProductStatusUnlisted = 0 // 下架
)
...
type Product struct {
	...
	Status       int            `gorm:"not null;default:1;type:tinyint;comment:状态 1:上架 0:下架"`
